...
class FriendsOrders extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    return (
      <div className="friendsChat _orders">
...
export default connect(mapStateToProps)(FriendsOrders);

FriendsOrders.propTypes = {
