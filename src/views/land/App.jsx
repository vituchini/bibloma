        ...
        <div className="landApp__inner">
          ...
          <div className="landApp__content">
            ...
            <div className="landApp__contentItem">
              ...
              <p className="landApp__contentDescription">
                Создавайте турниры, соревнуйтесь командами, общайтесь с друзьями, открывайте новые
                достижения, организовуйте игры следите за самыми последними новостями, а также
