...
class LandPlayers extends React.Component {
  ...
  players = [
    ...
    },
    {
      ...
      team: 'NAVI',
      description:
        'Очень доволен предоставленной свободой действий в платформе: гибкое создание турнира, формирование команды, общение и стриминг - все это дает гибкость и вариативность принимаемых решений.',
    },
    {
      image: 'player-5.png',
      nik: 'GoodKiller',
      ...
      team: 'NAVI',
      description:
        'Прозрачная партнерская система и функционал стриминга помогает мне транслировать свои игры и общаться с аудиторией и за рамками профессиональной деятельности.',
    },
  ];
