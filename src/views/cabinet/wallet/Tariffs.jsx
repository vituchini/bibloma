  ...
  tariffs = [
    {
      ...
      name: 'Базовая',
      price: 'Басплатно',
      subTitle: 'Значимость этих проблем настолько очевидна, что консультация',
      list: ['10% комиссия платформы', '50 матчей в истории', 'участие в любительских турнирах'],
    },
    {
      key: 'premium',
      ...
      price: '500₽ / мес',
      subTitle: 'Значимость этих проблем настолько очевидна, что консультация',
      list: ['5% комиссия платформы', '200 матчей в истории', 'участие в любительских турнирах'],
    },
    {
      key: 'star',
      ...
      list: [
        ...
        'участие в профессиональных турнирах',
      ],
    },
  ];
